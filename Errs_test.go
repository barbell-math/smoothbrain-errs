...
func TestUnwrap(t *testing.T) {
	e := Wrap(testErrOne, "%d", 100)
	smoothbraintest.Eq(t, testErrOne, Unwrap(e))
	smoothbraintest.ContainsError(t, testErrOne, Unwrap(e))
}
...
func TestAppendErrorOnlyFirst(t *testing.T) {
	...
	smoothbraintest.Eq(t, testErrOne.Error(), e.Error())
	smoothbraintest.Eq(t, testErrOne, e)
}
